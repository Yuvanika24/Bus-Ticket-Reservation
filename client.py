...
def yes():
    ...
    for i in range(t_rows1):
        for j in range(t_columns1):
            e1 = tkinter.Entry(frame7, width=20, fg='blue',font=('Arial',16,'bold'))
...
def book3():
    ...
    for i in range(t_rows1):
        for j in range(t_columns1):
            e1 = tkinter.Entry(frame5, width=20, fg='blue',font=('Arial',16,'bold'))
    ...
    yes_button.grid(row=6, column=1, pady=20)
...
def booking():
    ...
    for i in range(t_rows):
      for j in range(t_columns):
        e = tkinter.Entry(frame4, width=20, fg='blue',font=('Arial',16,'bold'))           
    ...
    book_button.grid(row=10, column=0, columnspan=2, pady=30)
    frame4.pack()
    window4.mainloop()
...
def seats():
    ...
    for i in range(t_rows):
      for j in range(t_columns):
        e = tkinter.Entry(frame2, width=20, fg='blue',font=('Arial',16,'bold'))
        e.grid(row=i+1, column=j)
        e.insert(END, Output[i][j])
